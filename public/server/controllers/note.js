...
exports.updateData = (req, res) => {
  upload(req, res, function (err) {
    ...
    var update = `UPDATE notes SET "papperType" = '${papperType}', "papperColor" = '${papperColor}', "title" = '${title}', "content" = '${content}', "imagePath" = '${path}', "imageName" = '${imageName}' WHERE "note_id" = '${noteId}'`;
